//Compilar utilizando:  gcc teste2malloc.c -o testeAA2 -lm parametroTAM 
...
*/
    Matriz3 = (int**)malloc(nLinhas1*sizeof(int*));
    for(i = 0;i<nLinhas1;i++) {
        Matriz3[i] = (int*)malloc(nColunas2*sizeof(int));
    }
    /////////////////////////////////////////////////////////

    //INICIALIZA VARIAVEIS
    data = malloc(nLinhas1*nColunas2*sizeof(POS));//VETOR DE STRUCTS CONTENDO CADA POSIÇAO DA MATRIZ RESULTADO
    tid = (pthread_t *)malloc(nLinhas1*nColunas2*sizeof(pthread_t));//CRIA VETOR DE ID THREADS
    ///////////////////////
